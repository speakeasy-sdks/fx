...
class ProductAPIErrorStatus(str, Enum):
...
class ProductAPIError(Exception):
    ...
    status: Optional[ProductAPIErrorStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""HttpStatus of the request : BAD_REQUEST, INTERNAL_SERVER_ERROR."""
